...
//Telegram Bot Details (Insert Your Bot Token and ID here"
#define BOTtoken "XXXXXXXXXX:xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
#define id_bot "XXXXXXXXXX"
...
void notification(float temperature,int room,int view){
  ...
  if (((room>=700)&&(room<2600))&&(buzzerState)){
    digitalWrite(buzzer,LOW);
    digitalWrite(red,LOW);
    digitalWrite(green,HIGH);
  }
  
  else if ((room<700)&&(buzzerState)){
